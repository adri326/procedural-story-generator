...
const Character = module.exports = class Character {
  ...
  getLongDescription() {
    ...
    let descriptor = [
      "[settings.furry and this.gender != 2]{name, this, true} {<be>, this} a {age, this} years old {gender, this, adjective} {species, this}."
      + "[settings.furry]{name, this, true} {<be>, this} a {age, this} years old {species, this}."
      + "[this.gender != 2]{name, this, true} {<be>, this} a {age, this} years old {gender, this, noun}."
      + "[true]{name, this, true} {<be>, this} {age, this} years old.",
